    ...
    <div class="h-full flex flex-col">
      ...
      <n-scrollbar style="flex:1">
        <div class="grid grid-cols-6 gap-2">
          <div v-for="name in filtered" :key="name" class="flex flex-col items-center gap-1 p-3 rounded-6px hover:bg-black/5 transition-colors cursor-pointer" :title="name">
            <span class="i-icon-park-outline inline-block text-[24px] text-[#1a1a1a]" :class="'i-icon-park-outline-' + name"></span>
